...
const menuItems = [
    ...
    { id: 3, name: 'Crispy Samosa Platter', description: 'Golden-fried pastries filled with spiced potatoes and peas.', price: '$9.99', category: 'Appetizers', image: 'https://images.pexels.com/photos/8471703/pexels-photo-8471703.jpeg', diet: 'Vegetarian', hint: 'samosa appetizer' },
    { id: 4, name: 'Gulab Jamun with Rabri', description: 'Soft, spongy berry-sized balls soaked in rose-scented syrup.', price: '$8.99', category: 'Desserts', image: 'https://images.pexels.com/photos/11519066/pexels-photo-11519066.jpeg', diet: 'Vegetarian', hint: 'indian dessert' },
    ...
    { id: 7, name: 'Vegetable Korma', description: 'Mixed vegetables cooked in a creamy, cashew-based sauce.', price: '$16.99', category: 'Main Course', image: 'https://images.pexels.com/photos/11551931/pexels-photo-11551931.jpeg', diet: 'Vegetarian', hint: 'vegetable korma' },
    { id: 8, name: 'Tandoori Roti', description: 'Whole wheat flatbread baked in a traditional clay tandoor.', price: '$3.99', category: 'Breads', image: 'https://images.pexels.com/photos/11566303/pexels-photo-11566303.jpeg', diet: 'Vegetarian', hint: 'indian bread' },
];
